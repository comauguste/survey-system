                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="account_type" aria-label="Select an account type"
                                        ...
                                        <option value="1" {{$user->account_type == 1 ? "selected" : ""}}>Administrator
                                        </option>
                                        <option value="2" {{$user->account_type == 2 ? "selected" : ""}}>Surveyor
                                        </option>
                                        <option value="3" {{$user->account_type == 3 ? "selected" : ""}}>Surveyee
                                        </option>
                                    </select>
                                </div>
                                <!--end::Col-->
                    ...
                    <div id="kt_account_deactivate" class="collapse show">
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <button id="kt_account_deactivate_account_submit" type="submit"
                                    class="btn btn-primary fw-bold">Update Account
                            </button>
                        </div>
                        <!--end::Card footer-->
                    </div>
