...
class LoginPage extends Page
{
    ...
    const USER_NAME = 'auguste compaore';
    const USER_EMAIL = 'user@user.com';
    const USER_PASS = 'password';
    const WRONG_USER_ = 'acompaore@gmail.com';
    const WRONG_USER_EMAIL = 'acompaore@gmail.com';
    const WRONG_USER_PASS = '12345678';
    const HOME_URL = '/';
    ...
    public static function assertLogin(Browser $browser)
    {
        ...
        $browser->type('name', LoginPage::USER_NAME);
        $browser->type('email', LoginPage::USER_EMAIL);
        $browser->type('password', LoginPage::USER_PASS);
        $browser->type('password_confirmation', LoginPage::USER_PASS);
