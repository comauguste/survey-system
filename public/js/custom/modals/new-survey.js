"use strict";
window.KTUtil = require('/public/js/components/util.js');
...
require('/public/js/vendors/plugins/sweetalert2.init.js');
...
var KTModalNewTarget = function () {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_survey');
			...
			form = document.querySelector('#kt_modal_new_survey_form');
			submitButton = document.getElementById('kt_modal_new_survey_submit');
			cancelButton = document.getElementById('kt_modal_new_survey_cancel');
